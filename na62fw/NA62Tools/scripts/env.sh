...
if [ "$CC7" -gt 0 ]; then
    ...
    if [ $LCG96 -gt 0 ]; then
        ...
        source /cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/Geant4/10.05.p01.1/x86_64-centos7-gcc8-opt/bin/geant4.sh
        source /cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/ROOT/6.18.00/x86_64-centos7-gcc8-opt/bin/thisroot.sh
        export LCGDIR=/cvmfs/sft.cern.ch/lcg/views/LCG_96_NA62/x86_64-centos7-gcc8-opt
        export BOOST=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/Boost/1.70.0/x86_64-centos7-gcc8-opt
        export BOOSTCOMP=""
        export BOOSTVER=""
        export SQLITE=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/sqlite/3280000/x86_64-centos7-gcc8-opt
        export XROOTD=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/xrootd/4.9.1/x86_64-centos7-gcc8-opt
        export FFTW3=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/fftw3/3.3.8/x86_64-centos7-gcc8-opt
        export TBB=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/tbb/2019_U7/x86_64-centos7-gcc8-opt
        export CMAKE=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/CMake/3.14.3/x86_64-centos7-gcc8-opt
        export GSL=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/GSL/2.5/x86_64-centos7-gcc8-opt
        export CLHEP=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/clhep/2.4.1.0/x86_64-centos7-gcc8-opt
        export QTDIR=/cvmfs/sft.cern.ch/lcg/releases/LCG_96_NA62/qt5/5.12.1/x86_64-centos7-gcc8-opt
    else
        ###### LCG 95
...
pathappend LD_LIBRARY_PATH ${NA62TOOLSSOURCE}/lib-${SYSTEMINSTALL}/ ${NA62TOOLSSOURCE}/lib-${SYSTEMINSTALL}/Persistency ${NA62TOOLSSOURCE}/lib-${SYSTEMINSTALL}/SlimPersistency
