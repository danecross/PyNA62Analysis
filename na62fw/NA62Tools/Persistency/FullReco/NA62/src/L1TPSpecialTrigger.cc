...
void L1PCSpecialBlock::Clear(Option_t* /*option*/){
  ...
  fNL1SpecialEvents = 0;
  fNL1ControlEvents = 0;
  fNL1PeriodicEvents = 0;
  fNL1PhysicsEvents = 0;
  fNL1PhysicsEventsInMultipleMasks = 0;
  fNL1DataRequests = 0;
  fNL1OutputEvents = 0;
  fNL1AcceptedEvents = 0;
  fNL1TimeoutEvents = 0;
  fNL1AllDisabledEvents = 0;
  fNL1BypassedEvents = 0;
  fNL1FlagAlgoEvents = 0;
  fNL1AutopassEvents = 0;
  fL1MasksInfo.clear();
}
