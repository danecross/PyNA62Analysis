...
Int_t NA62ConditionsService::Open(TString FileName){
  ...
  if(fAdditionalDirectoryPath!="") CheckDirectories.push_back(fAdditionalDirectoryPath); // Check in a custom additional dir as last chance
