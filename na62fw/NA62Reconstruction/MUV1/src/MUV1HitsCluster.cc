...
MUV1HitsCluster::MUV1HitsCluster() : fNHits(0){
}

void MUV1HitsCluster::Clear(Option_t * /*option*/)
{
  fNHits=0;
  fPosition=TVector3();
  fHits.clear();
...
void MUV1HitsCluster::AddHit(TRecoMUV1Hit *Hit){
...
void MUV1HitsCluster::UpdateValue(){
