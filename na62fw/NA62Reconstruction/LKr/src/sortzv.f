...
C
    2 IF (N.EQ.1)            RETURN
C
C     Integer and character sort disabled (not used in NA62Reco) to remove compilation wng
C     RF  KM   30.10.2017
C
      IF (MODE)    10,20,30
   10 PRINT *,'Integer sort not implemented'
      GO TO 50
C
   20 PRINT *,'Character sort not implemented'
      GO TO 50
C
