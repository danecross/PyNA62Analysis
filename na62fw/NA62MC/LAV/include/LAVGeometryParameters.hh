...
public:
  ...
  G4double GetBananaExtraRadiusTolerance(const G4int id, const G4int ib) { return fBananaExtraRadiusTolerance[id][ib]; };
...
private:
  ...
  G4double fBananaExtraRadiusTolerance[NUMBER_OF_BANANA_SHAPES][4]; // Extra tolerance in radial position of each block
