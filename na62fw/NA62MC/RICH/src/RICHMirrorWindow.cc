...
void RICHMirrorWindow::CreateGeometry()
{
    ...
    G4double MinTheta = asin(fInnerRadius/CurvatureRadius);
    G4double MaxTheta = asin(fOuterRadius/CurvatureRadius);
    ...
    G4Tubs* SolidInnerFlange = new G4Tubs("RICHMirrorWindowInnerFlange",
                                          ...
                                          startPhiAngle,
                                          deltaPhiAngle);                                                 
    G4VSolid* SolidMirrorWindowWithInnerFlange = new G4UnionSolid("SolidSphericalWindowWithOuterFlange",
    ...
    fLogicalVolume = new G4LogicalVolume(SolidMirrorWindowWithInnerFlange,        // solid
                                        fMaterial,             // material
