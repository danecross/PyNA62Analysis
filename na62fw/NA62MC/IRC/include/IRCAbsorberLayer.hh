...
//
// --------------------------------------------------------------------
#ifndef IRCAbsorberLayer_H
#define IRCAbsorberLayer_H 1
...
class IRCAbsorberLayer : public NA62VComponent
{

public:
  
  ~IRCAbsorberLayer();
  IRCAbsorberLayer(G4Material*, G4LogicalVolume*, G4Transform3D, G4double, G4double, G4int);
