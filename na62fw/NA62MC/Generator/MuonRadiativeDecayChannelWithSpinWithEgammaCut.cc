...
//      History:
//
//      26 July 2018 - Created by Artur Shaikhiev (artur.shaikhiev@cern.ch),
//                     based on G4MuonRaditiveDecayChannelWithSpin class (see info below)
//                   - Add hard-coded gamma energy cut E > 10 MeV
//
...
MuonRadiativeDecayChannelWithSpinWithEgammaCut::MuonRadiativeDecayChannelWithSpinWithEgammaCut()
	     : G4VDecayChannel(),
	       parent_polarization()
{
}
...
MuonRadiativeDecayChannelWithSpinWithEgammaCut::MuonRadiativeDecayChannelWithSpinWithEgammaCut(const MuonRadiativeDecayChannelWithSpinWithEgammaCut &right):
...
G4DecayProducts *MuonRadiativeDecayChannelWithSpinWithEgammaCut::DecayIt(G4double) 
{
  ...
  G4double Eg_min = 10.; // hard-coded minimum gamma energy
  G4double y_min = 2*Eg_min/(EMMU*(1.-eps*eps));
...
G4double MuonRadiativeDecayChannelWithSpinWithEgammaCut::fron(G4double Pmu,
                                                   G4double x,
                                                   G4double y,
                                                   G4double cthetaE,
                                                   G4double cthetaG,
