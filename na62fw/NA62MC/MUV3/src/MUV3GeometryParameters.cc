...
MUV3GeometryParameters::MUV3GeometryParameters() :
  NA62VGeometryParameters(G4String("MUV3")),
...
{
  // Beam pipe parameters (variable inherited from NA62VGeometryParameters)
