...
add_library(MC${SubDet} SHARED $<TARGET_OBJECTS:${SubDet}ObjLib>)
add_library(MC${SubDet}-static STATIC $<TARGET_OBJECTS:${SubDet}ObjLib>)


#Install libraries and headers
install(TARGETS MC${SubDet} MC${SubDet}-static DESTINATION lib-$ENV{SYSTEMINSTALL})
