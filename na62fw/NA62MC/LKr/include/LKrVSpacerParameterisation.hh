...
//
// --------------------------------------------------------------------
#ifndef LKrVSpacerParameterisation_H
#define LKrVSpacerParameterisation_H 1
...
class LKrVSpacerParameterisation : public G4VNestedParameterisation {
  public: 
    ~ LKrVSpacerParameterisation();
    explicit LKrVSpacerParameterisation(G4VPhysicalVolume* physVol);
    ...
    virtual G4Material* ComputeMaterial(G4VPhysicalVolume *,
        const G4int iSpacer,
        const G4VTouchable *);
    virtual G4int       GetNumberOfMaterials() const {return 3;};
