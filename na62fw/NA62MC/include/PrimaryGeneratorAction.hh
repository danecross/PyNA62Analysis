...
public:
  ...
  G4double GetMaxKaonMomentum() const       { return fMaxKaonMomentum; }
  void     SetMaxKaonMomentum(G4double val) { fMaxKaonMomentum = val;  }
  G4String GetDatacardName() const          { return fDatacardName;    }
...
private:
  ...
  G4double fMaxKaonMomentum; ///< Maximum K+ momentum allowed when traversing the GTK/CHANTI boundary. Negative value = no check made.
