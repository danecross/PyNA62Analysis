...
//
// --------------------------------------------------------------------
#ifndef SACAbsorberScintillator_H
#define SACAbsorberScintillator_H 1
...
class SACAbsorberScintillator : public NA62VComponent
{

public:
  
  ~SACAbsorberScintillator();
  SACAbsorberScintillator(G4Material*, G4LogicalVolume*);
