...
//
// --------------------------------------------------------------
#ifndef CHANTIMaterialParameters_H
#define CHANTIMaterialParameters_H 1
...
public:
  ...
  ~CHANTIMaterialParameters();
  static CHANTIMaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static CHANTIMaterialParameters* fInstance;
