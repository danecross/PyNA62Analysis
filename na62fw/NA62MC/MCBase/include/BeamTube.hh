...
public:
  ...
  G4LogicalVolume* GetLogicalBeamTube(){return fLogicalBeamTube;}
  G4LogicalVolume* GetLogicalBeamTubeEnvelope(){return fLogicalVolume;}
private:
  ...
  G4LogicalVolume* fLogicalBeamTube;
  G4VPhysicalVolume * fPhysicalBeamTube;
