...
//
// --------------------------------------------------------------------
#ifndef CHODQuadrant_H
#define CHODQuadrant_H 1
...
class CHODScintillatorCounter;

class CHODQuadrant : public NA62VComponent {

public:

  CHODQuadrant(G4Material*, G4LogicalVolume*, G4Transform3D, G4int);
  ~CHODQuadrant() {}
...
private:
  ...
  G4int fQuadrant;
  G4Transform3D fQuadrantTransform;
  ...
  G4int         fNCounters;
  G4ThreeVector fScintillatorSize[16];
  G4ThreeVector fScintillatorPosition[16];
  G4ThreeVector fBeamHolePosition;

  CHODScintillatorCounter* fScintillatorCounter;
};
