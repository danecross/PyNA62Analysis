...
//
// --------------------------------------------------------------------
#ifndef MUV1RubberPlate_H
#define MUV1RubberPlate_H 1
...
class MUV1RubberPlate : public NA62VComponent
{

public:
  
  ~MUV1RubberPlate();
  MUV1RubberPlate(G4Material*, G4LogicalVolume*, G4ThreeVector, G4ThreeVector, G4int);
...
private:
  ...
  G4ThreeVector fRubberPlateSize;
  G4ThreeVector fRubberPlatePosition;
