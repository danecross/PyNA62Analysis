...
void MUV1Groove::CreateGeometry()
{
  ...
  *g4rotY90 = g4rotY90->inverse();
  ...
  G4Box* fSolidVolume = new G4Box("groove_box",
				fFiberLength / 2. - tolerance, //make the groove length arbitrarily smaller than the corresponding scintillator length at the x - position of the groove shortest edge (relevant for the trapezoidal half strips)
				fGrooveWidth / 2.,
