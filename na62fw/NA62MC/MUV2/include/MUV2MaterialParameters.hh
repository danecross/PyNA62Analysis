...
//
// --------------------------------------------------------------------
#ifndef MUV2MaterialParameters_H
#define MUV2MaterialParameters_H 1
...
public:
  ...
  ~MUV2MaterialParameters();
  static MUV2MaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static MUV2MaterialParameters* fInstance;
