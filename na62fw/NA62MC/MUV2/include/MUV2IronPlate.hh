...
//
// --------------------------------------------------------------------
#ifndef MUV2IronPlate_H
#define MUV2IronPlate_H 1
...
class MUV2IronPlate : public NA62VComponent
{

public:
  
  ~MUV2IronPlate();
  MUV2IronPlate(G4Material*, G4LogicalVolume*, G4ThreeVector, G4ThreeVector, G4int);
