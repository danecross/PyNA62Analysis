...
#ifndef MUV2IronTube_H
#define MUV2IronTube_H 1
...
class MUV2IronTube : public NA62VComponent
{

public:
  
  MUV2IronTube(G4Material*, G4LogicalVolume*, G4double, G4ThreeVector, G4int);
  ~MUV2IronTube() {}
