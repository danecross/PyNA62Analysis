...
/// \Brief
/// Information about RICH rings and hits geometrically associatied to a Spectrometer track: a simplified algorithm developed in 2015
/// \EndBrief

SpectrometerRICHAssociationOutputSimple::SpectrometerRICHAssociationOutputSimple() {
  Clear();
}
...
void SpectrometerRICHAssociationOutputSimple::Clear() {
  fTrackID = fRingID = -1;
  fTrackTime = fTrackMomentum = fExpectedXRingCentre = fExpectedYRingCentre = fRingTime = 0.0;
  fRadiusMargin = 0.0;
  fRingExpectedRadiusEl = fRingExpectedRadiusMu = fRingExpectedRadiusPi = 0.0;
  ...
  fRingRadius = fRingChi2 = 0.0;
  fRingPosition.Set(0.0, 0.0);
}

void SpectrometerRICHAssociationOutputSimple::Print() {}
