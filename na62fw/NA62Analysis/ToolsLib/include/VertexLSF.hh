...
public:
  ...
  void     AddTrack(TMatrixD &par, TMatrixD &cov);
...
private:
  ...
  Int_t fNTracks;  ///< Number of tracks for the vertex fit
  Int_t fNStrawTracks; ///< Number of STRAW tracks
  Int_t fNGTKTracks;   ///< Number of GTK tracks
  ...
  TMatrixD fR;
  TMatrixD fH;
  std::vector<Int_t> fCharge; ///< Track charges
  std::vector<Int_t> fGTKtrk; ///< Straw (0) or GTK (1) track?
};
