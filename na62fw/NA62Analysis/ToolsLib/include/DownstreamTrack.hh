...
public:
  ...
  Double_t GetTrackLeadingTime()                   { return fTrackLeadingTime;       }
  void     SetTrackLeadingTime(Double_t val)       { fTrackLeadingTime = val;        }
  ...
  Double_t GetRICHSingleRingTrkSeededMass2()                           { return fRICHSingleRingTrkSeededMass2;               }
  void     SetRICHSingleRingTrkSeededMass2(Double_t val)               { fRICHSingleRingTrkSeededMass2 = val;                }
...
private:
  ...
  Double_t fTrackLeadingTime;      ///< Spectrometer track "leading time"
  ...
  Double_t fRICHSingleRingTrkSeededMass2;
