...
/// 4. decay selection (K2pi, Kmu2 + EventCleaning, KaonDecaySelection, PhotonRejection, PhotonRejectionLKr, StrawSegmentAlgorithm , MultiplicitySelection, TrackCalorimetricEnergyAssociation)
