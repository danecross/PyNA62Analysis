...
class SpectrometerRICHEventMonitor : public NA62Analysis::Analyzer {

public:

  explicit SpectrometerRICHEventMonitor(NA62Analysis::Core::BaseAnalysis *ba);
  ~SpectrometerRICHEventMonitor();
  void InitHist();
  void InitOutput() {}
  void DefineMCSimple() {}
  void Process(Int_t);
...
private:
  ...
  Int_t  fGraphCount;     ///< Counter of the number of output pages produced
