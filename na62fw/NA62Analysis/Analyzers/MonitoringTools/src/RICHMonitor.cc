...
void RICHMonitor::Process(Int_t) {
  ...
  fCDAcomp->SetLine1PointDir(TVector3(0.0, 0.0, 102000.0), KaonThreeMomentum);
  fCDAcomp->SetLine2PointDir(Scand->GetPositionBeforeMagnet(), Scand->GetThreeMomentumBeforeMagnet());
