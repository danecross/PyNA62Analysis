...
LAVGeometryParameters::LAVGeometryParameters() : NA62VGeometryParameters(G4String("LAV"))  {
  ...
  fBananaExtraRadiusTolerance[0] = 0.*um; // Extra tolerance in radial position of each block
  ...
  fBananaExtraRadiusTolerance[1] = 25.*um; // Extra tolerance in radial position of each block
  ...
  fBananaExtraRadiusTolerance[2] = 0.*um; // Extra tolerance in radial position of each block
  fAlSlabNVertices[2] = 11;
  fAlSlabVertex[2][0]  = G4TwoVector(   0.0*mm,   0.0*mm);
  fAlSlabVertex[2][1]  = G4TwoVector(-181.8*mm, -18.2*mm);
  fAlSlabVertex[2][2]  = G4TwoVector(-330.9*mm, -63.4*mm);
  fAlSlabVertex[2][3]  = G4TwoVector(-368.7*mm,  35.1*mm);
  fAlSlabVertex[2][4]  = G4TwoVector(-353.7*mm,  67.6*mm);
  fAlSlabVertex[2][5]  = G4TwoVector(-112.3*mm, 122.7*mm);
  fAlSlabVertex[2][6]  = G4TwoVector( 112.3*mm, 122.7*mm);
  fAlSlabVertex[2][7]  = G4TwoVector( 353.7*mm,  67.6*mm);
  fAlSlabVertex[2][8]  = G4TwoVector( 368.7*mm,  35.1*mm);
  fAlSlabVertex[2][9]  = G4TwoVector( 330.9*mm, -63.4*mm);
  fAlSlabVertex[2][10] = G4TwoVector( 181.8*mm, -18.2*mm);
  fBananaNAlColumns[2] = 12;
  fAlColumnPosition[2][0]  = G4TwoVector(  25.0*mm,  11.6*mm);
  fAlColumnPosition[2][1]  = G4TwoVector( 156.7*mm,   1.2*mm);
  fAlColumnPosition[2][2]  = G4TwoVector( 205.8*mm, -10.9*mm);
  fAlColumnPosition[2][3]  = G4TwoVector( 331.3*mm, -20.3*mm);
  fAlColumnPosition[2][4]  = G4TwoVector( 349.2*mm,  26.4*mm);
  fAlColumnPosition[2][5]  = G4TwoVector(  25.0*mm, 115.7*mm);
  fAlColumnPosition[2][6]  = G4TwoVector( -25.0*mm, 115.7*mm);
  fAlColumnPosition[2][7]  = G4TwoVector(-349.2*mm,  26.4*mm);
  fAlColumnPosition[2][8]  = G4TwoVector(-331.3*mm, -20.3*mm);
  fAlColumnPosition[2][9]  = G4TwoVector(-205.8*mm, -10.9*mm);
  fAlColumnPosition[2][10] = G4TwoVector(-156.7*mm,   1.2*mm);
  fAlColumnPosition[2][11] = G4TwoVector( -25.0*mm,  11.6*mm);
  fBananaAlCShapeScrewsPosition[2][0][0] = G4TwoVector( 227.6*mm, 90.8*mm);
  fBananaAlCShapeScrewsPosition[2][0][1] = G4TwoVector( 178.6*mm,100.6*mm);
  fBananaAlCShapeScrewsPosition[2][1][0] = G4TwoVector(-227.6*mm, 90.8*mm);
  fBananaAlCShapeScrewsPosition[2][1][1] = G4TwoVector(-178.6*mm,100.6*mm);
  ...
  fBananaExtraRadiusTolerance[3] = 0.*um; // Extra tolerance in radial position of each block
  fAlSlabNVertices[3] = 0;
  //fAlSlabVertex[3][0]  = G4TwoVector(   0.0*mm,   0.0*mm);
  //fAlSlabVertex[3][1]  = G4TwoVector( 181.8*mm, -18.2*mm);
  //fAlSlabVertex[3][2]  = G4TwoVector( 330.9*mm, -63.4*mm);
  //fAlSlabVertex[3][3]  = G4TwoVector( 368.7*mm,  35.1*mm);
  //fAlSlabVertex[3][4]  = G4TwoVector( 353.7*mm,  67.6*mm);
  //fAlSlabVertex[3][5]  = G4TwoVector( 112.3*mm, 122.7*mm);
  //fAlSlabVertex[3][6]  = G4TwoVector(-112.3*mm, 122.7*mm);
  //fAlSlabVertex[3][7]  = G4TwoVector(-353.7*mm,  67.6*mm);
  //fAlSlabVertex[3][8]  = G4TwoVector(-368.7*mm,  35.1*mm);
  //fAlSlabVertex[3][9]  = G4TwoVector(-330.9*mm, -63.4*mm);
  //fAlSlabVertex[3][10] = G4TwoVector(-181.8*mm, -18.2*mm);
  fBananaNAlColumns[3] = 0;
  //fAlColumnPosition[3][0]  = G4TwoVector(  25.0*mm,  11.6*mm);
  //fAlColumnPosition[3][1]  = G4TwoVector( 156.7*mm,   1.2*mm);
  //fAlColumnPosition[3][2]  = G4TwoVector( 205.8*mm, -10.9*mm);
  //fAlColumnPosition[3][3]  = G4TwoVector( 331.3*mm, -20.3*mm);
  //fAlColumnPosition[3][4]  = G4TwoVector( 349.2*mm,  26.4*mm);
  //fAlColumnPosition[3][5]  = G4TwoVector(  25.0*mm, 115.7*mm);
  //fAlColumnPosition[3][6]  = G4TwoVector( -25.0*mm, 115.7*mm);
  //fAlColumnPosition[3][7]  = G4TwoVector(-349.2*mm,  26.4*mm);
  //fAlColumnPosition[3][8]  = G4TwoVector(-331.3*mm, -20.3*mm);
  //fAlColumnPosition[3][9]  = G4TwoVector(-205.8*mm, -10.9*mm);
  //fAlColumnPosition[3][10] = G4TwoVector(-156.7*mm,   1.2*mm);
  //fAlColumnPosition[3][11] = G4TwoVector( -25.0*mm,  11.6*mm);
  //fBananaAlCShapeScrewsPosition[3][0][0] = G4TwoVector( 227.6*mm, 90.8*mm);
  //fBananaAlCShapeScrewsPosition[3][0][1] = G4TwoVector( 178.6*mm,100.6*mm);
  //fBananaAlCShapeScrewsPosition[3][1][0] = G4TwoVector(-227.6*mm, 90.8*mm);
  //fBananaAlCShapeScrewsPosition[3][1][1] = G4TwoVector(-178.6*mm,100.6*mm);
