...
//
// --------------------------------------------------------------------
#ifndef SACMaterialParameters_H
#define SACMaterialParameters_H 1
...
public:
  ...
  ~SACMaterialParameters();
  static SACMaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static SACMaterialParameters* fInstance;
