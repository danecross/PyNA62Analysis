...
//
// --------------------------------------------------------------------
#ifndef SACScintillatorLayer_H
#define SACScintillatorLayer_H 1
...
class SACScintillatorLayer : public NA62VComponent
{

public:
  
  ~SACScintillatorLayer();
  SACScintillatorLayer(G4Material*, G4LogicalVolume*, G4Transform3D, G4int);
