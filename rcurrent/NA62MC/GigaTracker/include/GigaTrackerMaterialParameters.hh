...
// --------------------------------------------------------------
//
#ifndef GigaTrackerMaterialParameters_H
#define GigaTrackerMaterialParameters_H 1
...
public:
  ...
  ~GigaTrackerMaterialParameters();
  static GigaTrackerMaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static GigaTrackerMaterialParameters* fInstance;
