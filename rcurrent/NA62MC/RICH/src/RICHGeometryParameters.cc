...
//  fRespRegionZEnd        = 237.588*m;// 237.700*m;
  ...
  fBeamPipeOuterRadius[0] = 86.0*mm;
  fBeamPipeInnerRadius[0] = 84.0*mm;
  fBeamPipeZPosition[0] = fBeamWindowInnerFlangeZPosition-fBeamWindowInnerFlangeZLength*0.5-fBeamPipeZLength[0]*0.5;
  fBeamPipeFinZLength[0] = 5.0*mm;
  fBeamPipeFinOuterRadius[0] = 89.0*mm;
  fBeamPipeFinSpacing[0] = 40.0*mm;

  //G4cout<<" *********** BeamPipe[0] OuterRadius: "<<fBeamPipeOuterRadius[0] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[0] ZLength: "<<fBeamPipeZLength[0] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[0] ZPosition: "<<fBeamPipeZPosition[0] <<" ***********"<<G4endl;

  fBeamPipeZLength[1] = fBeamWindowInnerFlangeZLength;
  fBeamPipeOuterRadius[1] = 85.0*mm;
  fBeamPipeInnerRadius[1] = 84.0*mm;
  fBeamPipeZPosition[1] = fBeamWindowInnerFlangeZPosition; // RICH ref syst
  fBeamPipeFinZLength[1] = 5.0*mm;
  fBeamPipeFinOuterRadius[1] = 89.0*mm;
  fBeamPipeFinSpacing[1] = 40.0*mm;

  //G4cout<<" *********** BeamPipe[1] OuterRadius: "<<fBeamPipeOuterRadius[1] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[1] ZLength: "<<fBeamPipeZLength[1] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[1] ZPosition: "<<fBeamPipeZPosition[1] <<" ***********"<<G4endl;        

  fBeamPipeZLength[2] = fMirrorWindowInnerFlangeZPosition - fMirrorWindowInnerFlangeZLength*0.5 - fBeamWindowInnerFlangeZPosition - fBeamWindowInnerFlangeZLength *0.5;
  fBeamPipeOuterRadius[2] = 85.0*mm;
  fBeamPipeInnerRadius[2] = 84.0*mm;
  fBeamPipeZPosition[2] = fMirrorWindowInnerFlangeZPosition - fMirrorWindowInnerFlangeZLength*0.5 - fBeamPipeZLength[2]*0.5; // RICH ref syst
  fBeamPipeFinZLength[2] = 5.0*mm;
  fBeamPipeFinOuterRadius[2] = 89.0*mm;
  fBeamPipeFinSpacing[2] = 40.0*mm;

  //G4cout<<" *********** BeamPipe[2] OuterRadius: "<<fBeamPipeOuterRadius[2] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[2] ZLength: "<<fBeamPipeZLength[2] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[2] ZPosition: "<<fBeamPipeZPosition[2] <<" ***********"<<G4endl;      

  fBeamPipeZLength[3] = fMirrorWindowInnerFlangeZLength;
  fBeamPipeOuterRadius[3] = 85.0*mm;
  fBeamPipeInnerRadius[3] = 84.0*mm;
  fBeamPipeZPosition[3] = fMirrorWindowInnerFlangeZPosition; // RICH ref syst
  fBeamPipeFinZLength[3] = 5.0*mm;
  fBeamPipeFinOuterRadius[3] = 89.0*mm;
  fBeamPipeFinSpacing[3] = 40.0*mm;

  //G4cout<<" *********** BeamPipe[3] OuterRadius: "<<fBeamPipeOuterRadius[3] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[3] ZLength: "<<fBeamPipeZLength[3] <<" ***********"<<G4endl;
  //G4cout<<" *********** BeamPipe[3] ZPosition: "<<fBeamPipeZPosition[3] <<" ***********"<<G4endl;      


  fBeamWindowInnerFlangeInnerRadius = fBeamPipeOuterRadius[1];
  fBeamWindowInnerFlangeRadialThickness = fBeamWindowInnerRadius-fBeamWindowInnerFlangeInnerRadius;


  fMirrorWindowInnerFlangeInnerRadius = fBeamPipeOuterRadius[3];
...
//// fine debug
  ...
  fBeamPipeZLengthWFins[1] = fBeamPipeZLength[1]-fBeamWindowInnerFlangeZLength-fMirrorWindowInnerFlangeZLength; 
  

  fBeamPipeZLength[2] = fMirrorWindowZLength-fMirrorWindowInnerFlangeZLength*0.5; 
  fBeamPipeZPosition[2] = fRICHDetectorZEnd-fBeamPipeZLength[2]*0.5-fRICHDetectorZPosition;
  fBeamPipeInnerRadius[2] = 84.0*mm;
  fBeamPipeOuterRadius[2] = 85.0*mm;  
  fBeamPipeFinZLength[2] = 5.0*mm;
  fBeamPipeFinOuterRadius[2] = 89.0*mm;
  ...
  fRadiatorZLength = fVesselZLength;
  fRadiatorInnerRadius = fBeamPipeFinOuterRadius[1];
...
// inizio parametri nuovi 
  ...
  fSubHalfMirrorHoleRadius = fBeamPipeFinOuterRadius[1] + 2*mm;  
...
// inizio parametri supporto specchi
  ...
  fMirrorSupportPanelInnerRadius=fBeamPipeFinOuterRadius[1]+11.0*mm; // 89*mm+11*mm=100*mm
...
// 	 << "fRadiatorZLength= "<< fRadiatorZLength << G4endl
