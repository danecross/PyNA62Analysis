...
//
// --------------------------------------------------------------
#ifndef SpectrometerMaterialParameters_H
#define SpectrometerMaterialParameters_H 1
...
public:
  ...
  ~SpectrometerMaterialParameters();
  static SpectrometerMaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static SpectrometerMaterialParameters* fInstance;
