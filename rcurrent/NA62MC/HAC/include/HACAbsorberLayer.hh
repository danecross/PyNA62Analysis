...
//
// --------------------------------------------------------------------
#ifndef HACAbsorberLayer_H
#define HACAbsorberLayer_H 1
...
class HACAbsorberLayer : public NA62VComponent
{

public:
  
  ~HACAbsorberLayer();
  HACAbsorberLayer(G4Material*, G4LogicalVolume*, G4Transform3D, G4int);
