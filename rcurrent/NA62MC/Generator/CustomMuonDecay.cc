...
//      History:
//
//      2017-10-09 Created by Karim Massri (karim.massri@cern.ch),
//                 based on G4MuonDecayChannelWithSpin class (see info below)
//
...
CustomMuonDecay::CustomMuonDecay():
  G4MuonDecayChannel(),
  parent_polarization(), EMMU( 0.*MeV), EMASS( 0.*MeV)
{}

CustomMuonDecay::CustomMuonDecay(const G4String& theParentName, G4double theBR):
...
CustomMuonDecay::CustomMuonDecay(const CustomMuonDecay &right):
...
G4DecayProducts *CustomMuonDecay::DecayIt(G4double) {
  ...
  G4DynamicParticle * daughterparticle0 
    = new G4DynamicParticle( GetDaughter(0), daughtermomentum[0]*direction0);
  ...
  G4DynamicParticle * daughterparticle1 
    = new G4DynamicParticle( GetDaughter(1), direction1*(vmass/2.));
  G4DynamicParticle * daughterparticle2
    = new G4DynamicParticle( GetDaughter(2), direction1*(-1.0*vmass/2.));
