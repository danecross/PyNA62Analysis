...
//
// --------------------------------------------------------------------
#ifndef NewCHODMaterialParameters_H
#define NewCHODMaterialParameters_H 1
...
public:
  ...
  ~NewCHODMaterialParameters() {}
  static NewCHODMaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static NewCHODMaterialParameters* fInstance;
