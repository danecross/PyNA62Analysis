...
//
// --------------------------------------------------------------
#ifndef LKrMaterialParameters_H
#define LKrMaterialParameters_H 1
...
class LKrMaterialParameters
{
    ...
    public:
        ...
        ~LKrMaterialParameters();
        static LKrMaterialParameters* GetInstance();
        TObjArray GetHashTable();
        void Print();

    private:

        static LKrMaterialParameters* fInstance;
