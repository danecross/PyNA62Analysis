...
LKrBeamPipe::LKrBeamPipe (G4Material * Material, G4LogicalVolume * MotherVolume, 
...
LKrBeamPipe::~LKrBeamPipe(){}


void LKrBeamPipe::ReadGeometryParameters()
{
...
void LKrBeamPipe::CreateGeometry()
{
...
void LKrBeamPipe::SetProperties()
{
