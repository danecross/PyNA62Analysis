...
LKrElectrodes::LKrElectrodes (G4Material * Material, G4LogicalVolume * MotherVolume, G4String PathToLKrShowersDb): NA62VComponent(Material,MotherVolume), fPathToLKrShowersDb(PathToLKrShowersDb){
...
void LKrElectrodes::CreateGeometry(){
  ...
  fShowers = new LKrEMShowers("fastShowerSimu",caloRegion, fPathToLKrShowersDb);
}
