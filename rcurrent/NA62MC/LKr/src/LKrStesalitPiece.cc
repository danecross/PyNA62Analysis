...
void LKrStesalitPiece::CreateGeometry()
{
  ...
  Ta = G4ThreeVector(Xtr,Ytr,Ztr);
     
  G4Box* fSolidBox = new G4Box("StesalitPiece", pDx, pDy, pDz);
   
  G4Tubs* VirtualTube = new G4Tubs("virtual tube",                        
				   0. ,
 ...
 G4SubtractionSolid* fSolidVolume = new G4SubtractionSolid("IntersectedSolid",
							   new G4DisplacedSolid("intersected",fSolidBox,0,G4ThreeVector(Xtr,Ytr,0)),
							   VirtualTube
							   );
