...
class MUV1Fiber;
class MUV1Groove : public NA62VComponent
{

public:
  
MUV1Groove(G4Material * Material,
  ...
  void CreateGeometry();
  void SetProperties();
  MUV1Fiber* GetFiber() { return fFiber;} ;
  G4VPhysicalVolume* GetGroovePhys() {return fPhysicalVolume; } ;
