...
//
// --------------------------------------------------------------------
#ifndef MUV1MaterialParameters_H
#define MUV1MaterialParameters_H 1
...
public:
  ...
  ~MUV1MaterialParameters();
  static MUV1MaterialParameters* GetInstance();
  TObjArray GetHashTable();
  void Print();

private:

  static MUV1MaterialParameters* fInstance;
