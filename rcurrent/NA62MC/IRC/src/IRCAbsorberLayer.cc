...
IRCAbsorberLayer::IRCAbsorberLayer(G4Material * Material, G4LogicalVolume * MotherVolume, 
...
IRCAbsorberLayer::~IRCAbsorberLayer(){}

void IRCAbsorberLayer::ReadGeometryParameters()
{
  ...
  fZLength = GeoPars->GetAbsorberLayerZLength();
  fXdisplacement = GeoPars->GetIRCInnerHoleDisplacementX();
}

void IRCAbsorberLayer::CreateGeometry()
{
  ...
  fSolidVolume = new G4SubtractionSolid("IRCAbsorberLayer",plate,hole,Rotation,Displacement);
  
  fLogicalVolume= new G4LogicalVolume(fSolidVolume,                        // solid
				      fMaterial,                           // material
				      "IRCAbsorberLayer",                  // name
				      0,                                   // field manager 
...
void IRCAbsorberLayer::SetProperties()
{
