...
//
// --------------------------------------------------------------------
#ifndef IRCScintillatorLayer_H
#define IRCScintillatorLayer_H 1
...
class IRCScintillatorLayer : public NA62VComponent
{

public:
  
  ~IRCScintillatorLayer();
  IRCScintillatorLayer(G4Material*, G4LogicalVolume*, G4Transform3D, G4double, G4double, G4int);
