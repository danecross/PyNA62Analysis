...
//
// --------------------------------------------------------------------
#ifndef IRCAluminumLayer_H
#define IRCAluminumLayer_H 1
...
class IRCAluminumLayer : public NA62VComponent
{

public:
  
  ~IRCAluminumLayer();
  IRCAluminumLayer(G4Material*, G4LogicalVolume*, G4Transform3D, G4double, G4double, G4double, G4int);
