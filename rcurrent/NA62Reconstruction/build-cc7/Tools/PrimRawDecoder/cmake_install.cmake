# Install script for directory: /afs/cern.ch/user/d/dacross/na62fw/NA62Reconstruction/Tools/PrimRawDecoder
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xtoolsexex" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin-cc7" TYPE EXECUTABLE FILES "/afs/cern.ch/user/d/dacross/na62fw/NA62Reconstruction/build-cc7/Tools/PrimRawDecoder/PrimRawDecoder")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimRawDecoder" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimRawDecoder")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimRawDecoder"
