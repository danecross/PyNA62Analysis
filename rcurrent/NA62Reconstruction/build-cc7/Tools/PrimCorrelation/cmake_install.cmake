# Install script for directory: /afs/cern.ch/user/d/dacross/na62fw/NA62Reconstruction/Tools/PrimCorrelation
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xtoolsexex" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin-cc7" TYPE EXECUTABLE FILES "/afs/cern.ch/user/d/dacross/na62fw/NA62Reconstruction/build-cc7/Tools/PrimCorrelation/PrimCorrelation")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimCorrelation" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimCorrelation")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin-cc7/PrimCorrelation"
