...
SpectrometerParameters* SpectrometerParameters::fInstance = 0;
...
SpectrometerParameters::SpectrometerParameters(){
  ...
  fT0FileName = "";
  fAlignmentFileName = "";
  fStationsAlignmentFileName = "";
  fZCorrectionFileName = "";
  fBxIntegralFileName = "";
  fByIntegralFileName = "";
  fBMNP33FileName = "";
  fBFringeFileName = "";
  ...
  fMaxHitPlane = 0;
  fTDriftMax = 0;
  fTTrailingCut2Hits = 0;
  fTTrailingSigma3Hits = 0;
  fTTrailingSigma2Hits = 0;
  fRadiusSum3HitsMin = 0;
  fRadiusSum3HitsMax = 0;
  fRadiusSum2HitsMax = 0;
  fDeltaStrawPositionMax = 0;
  fChi2Triplet = 0;
  fTripletParameter1 = 0;
  fTripletParameter2 = 0;
  fTripletParameter3 = 0;
  fTripletParameter4 = 0;
  fDoubletParameter1 = 0;
  fDoubletParameter2 = 0;
  fDoubletParameter3 = 0;
  fPlaneStaggering = 0;
  fHitSlopeMax = 0;
  fNSigmaSlopeCut = 0;
  fInterTtrailingCut = 0;
  fInterDistanceCut = 0;
  fInterQuality4ViewsCut1 = 0;
  fInterQuality4ViewsCut2 = 0;
  fInterQuality4ViewsCut3 = 0;
  fInterQuality4ViewsCut4 = 0;
  fInter4ViewsTtrailingSigma = 0;
  fInterQuality3ViewsCutXYU = 0;
  fInterQuality3ViewsCutXYV = 0;
  fInterQuality3ViewsCutXUV = 0;
  fInterQuality3ViewsCutYUV = 0;
  fInter3ViewsTtrailingSigma = 0;
  fCombinationXCorridor0 = 0;
  fCombinationXCorridor1 = 0;
  fCombinationXCorridor2 = 0;
  fCombinationXCorridor3 = 0;
  fCombinationYCorridor0 = 0;
  fCombinationYCorridor1 = 0;
  fCombinationYCorridor2 = 0;
  fCombinationYCorridor3 = 0;
  f3HitsCombRadiusAtMC = 0;
  fMaxMomentum = 0;
  fMaxAngle = 0;
  fCombQualityCut = 0;
  fCombHoughDeltaCut = 0;
  fGuessAverageSigma = 0;
  fGuessSingletSigma = 0;
  fZRef = 0;
  fXX0perPlane = 0;
  for (Int_t j = 0; j < 4; j++) {
    fCutDyFit[j] = 0;
  ...
  fMagicT0 = 0;
  fMagicT0ScanEnabled = false;
  fMagicT0FileName = "";
  fZMagnetCorrection = 0;
  for (Int_t j = 0; j < 4; j++) {
  ...
  fGain = 0;
  fCARIOCASlope = 0;
  fEquivalentNoiseCharge = 0;
  fIonizationEnergy = 0;
  fNTotalPermm = 0;
  fNoiseSimu = false;
  fSavePulseShapes = false;
  fNoBulkHits = false;
}

SpectrometerParameters * SpectrometerParameters::GetInstance()
{
/// \MemberDescr
/// \return SpectrometerParameters::fInstance.
/// \EndMemberDescr
  if (!fInstance) fInstance = new SpectrometerParameters();
  return fInstance;
}
...
void SpectrometerParameters::SetT0(Int_t /*runNumber*/)
{
/// \MemberDescr
/// T0:
/// \n
...
/// \EndMemberDescr
  ...
  while(!NA62ConditionsService::GetInstance()->Get(fXTFileName).eof()){
    ...
    if(b.find("#") == 0) continue; // skip commented lines
    if(q>=16) {
