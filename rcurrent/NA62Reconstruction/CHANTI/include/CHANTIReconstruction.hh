...
public:
  ...
  Double_t GetTHRL()                                { return fTHRL;                                 };
  Double_t GetTHRH()                                { return fTHRH;                                 };
...
private:
  ...
  TRecoCHANTICandidate* fCandidate;
  Int_t fNRings;
  Int_t fNPlanes;
  Int_t fNFiredRing;
  Int_t fNFiredPlane;
  ...
  Double_t fTHRL;		///<	This is the low threshold (mV) for digitized signal
  Double_t fTHRH;		///<	This is the high threshold (mV) for digitized signal
