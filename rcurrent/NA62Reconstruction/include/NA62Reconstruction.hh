...
class NA62Reconstruction : public NA62VReconstruction {
  ...
  private:
    ...
    enum RecoStage {
      kStageNone      = 0x0,             ///< No processing 
      kStageDigis     = 0x1,             ///< Only digitization
      kStageRawHistos = 0x2,             ///< Only digitization, no tree saved
      kStageReco      = 0x3,             ///< Full reconstruction
      kStageHistos    = 0x4,             ///< Full reconstruction, no tree saved
      kStageBinary    = 0x5              ///< Binary conversion
    };
    ...
    RecoEventVector fRecoEvents;         ///< Vector if subdetector RecoEvents which hold the reconstructed information 
    ...
    Bool_t fWriteDigis;                              ///< Flag to enable/disable the writing of digis when the stage "Reco" is selected
