...
#define R__DICTIONARY_FILENAME GigaTrackerDICT
...
namespace {
  void TriggerDictionaryInitialization_libGigaTracker_Impl() {
...
"/afs/cern.ch/na62/offline/NA62FW/dev/rcurrent/NA62Reconstruction/build-slc6/GigaTracker/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libGigaTracker dictionary forward declarations' payload"
...
#line 1 "libGigaTracker dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libGigaTracker",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libGigaTracker_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libGigaTracker_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libGigaTracker() {
  TriggerDictionaryInitialization_libGigaTracker_Impl();
}
