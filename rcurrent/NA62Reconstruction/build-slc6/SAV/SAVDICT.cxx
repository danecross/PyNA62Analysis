...
#define R__DICTIONARY_FILENAME SAVDICT
...
namespace {
  void TriggerDictionaryInitialization_libSAV_Impl() {
...
"/afs/cern.ch/na62/offline/NA62FW/dev/rcurrent/NA62Reconstruction/build-slc6/SAV/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libSAV dictionary forward declarations' payload"
...
#line 1 "libSAV dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libSAV",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libSAV_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libSAV_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libSAV() {
  TriggerDictionaryInitialization_libSAV_Impl();
}
