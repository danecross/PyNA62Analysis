...
#define R__DICTIONARY_FILENAME CedarDICT
...
namespace {
  void TriggerDictionaryInitialization_libCedar_Impl() {
...
"/afs/cern.ch/na62/offline/NA62FW/dev/rcurrent/NA62Reconstruction/build-slc6/Cedar/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libCedar dictionary forward declarations' payload"
...
#line 1 "libCedar dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libCedar",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libCedar_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libCedar_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libCedar() {
  TriggerDictionaryInitialization_libCedar_Impl();
}
