...
#define R__DICTIONARY_FILENAME MUV3DICT
...
namespace {
  void TriggerDictionaryInitialization_libMUV3_Impl() {
...
"/afs/cern.ch/na62/offline/NA62FW/dev/rcurrent/NA62Reconstruction/build-slc6/MUV3/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libMUV3 dictionary forward declarations' payload"
...
#line 1 "libMUV3 dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libMUV3",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libMUV3_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libMUV3_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libMUV3() {
  TriggerDictionaryInitialization_libMUV3_Impl();
}
