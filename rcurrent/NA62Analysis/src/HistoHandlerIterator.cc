...
typename std::vector<PointerType*>::iterator HistoHandler::Iterator<PointerType>::end(){
	/// \MemberDescr
	/// For compatibility with std iterators algorithms\n
	/// See End()
	/// \EndMemberDescr
...
template class HistoHandler::Iterator<TH3>;
template class HistoHandler::Iterator<TGraph>;
template class HistoHandler::Iterator<TEfficiency>;
template class HistoHandler::Iterator<CanvasOrganizer>;
