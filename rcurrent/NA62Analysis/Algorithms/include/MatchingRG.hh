...
public:
  ...
  virtual ~MatchingRG();
  void Init(TString);
  void Process(TRecoGigaTrackerEvent*, TRecoSpectrometerCandidate*, double, double, double, bool, bool, TString);
  ...
  bool IsBeamParticle(TRecoGigaTrackerCandidate*, bool, bool, TString);
  void FindBestGTK(TRecoGigaTrackerCandidate*, TRecoSpectrometerCandidate*, double, double, int, bool, bool, TString);
  void FindBestPU(std::vector<int>, std::vector<double>, int, std::vector<int>&, std::vector<double>&, bool);
  void SetMinD(double);
  ...
  bool AreSimilar(int, int, bool, bool, TString);
