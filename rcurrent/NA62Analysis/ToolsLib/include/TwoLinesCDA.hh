...
public:
  ...
  void SetLine1Point1 (TVector3 val) { fL1p1 = val; fv1 = fL1p2-fL1p1; }
  void SetLine1Point2 (TVector3 val) { fL1p2 = val; fv1 = fL1p2-fL1p1; }
  void SetLine2Point1 (TVector3 val) { fL2p1 = val; fv2 = fL2p2-fL2p1; }
  void SetLine2Point2 (TVector3 val) { fL2p2 = val; fv2 = fL2p2-fL2p1; }
