 ...
 * Chi2 Fit
 ************************************************/
Bool_t RICHSingleRingTrkSeededFit::Chi2Fit(TRecoRICHEvent* event, TRecoRICHCandidate *thisRing, TVector3 pmtpos, Int_t &SRNHits, Double_t &SRRadius, Double_t &SRChi2, Double_t &SRTime)
