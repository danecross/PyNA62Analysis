...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:~/na62fw/NA62Analysis/lib-cc7/:$ROOTSYS:/cvmfs/sft.cern.ch/lcg/releases/LCG_95/Boost/1.69.0/x86_64-slc6-gcc7-opt/lib/
